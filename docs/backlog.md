...
| --- | --- | --- | --- | --- |
| Primitive data model cutover | Active trunk | `PDM-GAP-001`, `PDM-GAP-002`, `PDM-GAP-003`, `PDM-GAP-004`, `PDM-GAP-005`, `PDM-GAP-006`, `EXEC-GAP-008` | Replaces the current timing-mode shape with composable primitives that can express the workout types Setmark needs. | Continue from `docs/specs/primitives-data-model.md` and its remaining proof matrix. Next implementation should start with `PDM-GAP-006`, `bug-089`, and `bug-090`; do not preserve old scratch phase files. |
