// TestSupport.swift
//
// CLT-friendly assertion harness, matching the pattern used by
// Core/Foundation, Core/Domain, Core/Prescription, and Sync. Kept in-package
// so the test helpers do not ship as a public library.
