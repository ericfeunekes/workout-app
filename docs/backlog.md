...
| Today and workout preview | Parallel app lane | `TODAY-GAP-001`, `TODAY-GAP-002`, `TODAY-GAP-003`, `PREVIEW-GAP-001`, `PREVIEW-GAP-002`, `PREVIEW-GAP-003`, `PREVIEW-GAP-004` | Makes the workout entry path clear, editable where intended, and backed by the same execution projection used by Active. | Create the dedicated preview view/sheet seam before adding richer edit interactions, then prove the flow in simulator. |
| Execute loop, timing, and transitions | Parallel app lane | `EXEC-GAP-001`, `EXEC-GAP-003`, `EXEC-GAP-004`, `EXEC-GAP-006`, `EXEC-GAP-007`, `EXEC-GAP-009`, `EXEC-GAP-010`, `EXEC-GAP-011`, `EXEC-GAP-012`, `TIMING-GAP-001`, `TIMING-GAP-002`, `TIMING-GAP-003`, `AUTO-GAP-001`, `AUTO-GAP-002`, `AUTO-GAP-003`, `SWAP-GAP-001`, `SWAP-GAP-002`, `SWAP-GAP-003`, `SWAP-GAP-004`, `SWAP-GAP-005`, `TRANS-GAP-001`, `TRANS-GAP-002`, `TRANS-GAP-003` | Keeps the core workout flow aligned with current requirements while primitives are being prepared. | Pick one behavior cluster. Create component/sheet seams before expanding interactions; use ETTrace for timer-runtime claims. |
...
| Save, persistence, and push | Parallel reliability lane | `SAVE-GAP-001`, `SAVE-GAP-002`, `PERSIST-GAP-001`, `PERSIST-GAP-002`, `PERSIST-GAP-003`, `PUSH-GAP-002`, `SYNC-GAP-001`, `SYNC-GAP-004` | Protects logged workout data across completion, relaunch, offline use, and foreground/background sync. | Choose expiry, foreground lifecycle, background push, or diagnostics gaps explicitly; avoid broad sync rewrites. |
...
| Testing proof infrastructure | Parallel proof lane | `TEST-GAP-001`, `TEST-GAP-002`, `TEST-GAP-003`, `TEST-GAP-004`, `TEST-GAP-005` | Builds the realistic-local, app-hosted, lifecycle, runtime-cost, and object-lifetime harnesses that pre-QA needs before simulator/device QA can be trusted for boundary claims. | Promote when a selected implementation depends on a missing proof harness; otherwise keep the gap explicit. Feature-specific proof gaps stay in their feature lanes. |
