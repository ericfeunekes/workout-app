// TestSupport.swift
//
// Same CLT-friendly assertion harness pattern as Core/Foundation. Kept
// in-package (not shared via a library target) because tests shouldn't
// introduce a public dependency that ships with the app.
