// TestSupport.swift
//
// Minimal assertion harness — same shape as Core/Foundation, Core/Domain,
// Core/Prescription, and Core/Autoreg. Non-zero exit on failure so
// `swift run CoreSessionTests` propagates a real failure signal in CI
// or pre-push.
