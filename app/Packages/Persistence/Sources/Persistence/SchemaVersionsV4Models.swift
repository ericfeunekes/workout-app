// SchemaVersionsV4Models.swift
//
// Perf-002-era `@Model` snapshots, nested inside `WorkoutDBSchemaV4`.
// V4 is the last schema before the skipped/side/intent cutover. Keeping
// it as a real snapshot is what lets SwiftData see the V4 -> V5 diff
// instead of comparing the latest models to themselves.

import Foundation
import SwiftData

extension WorkoutDBSchemaV4 {
